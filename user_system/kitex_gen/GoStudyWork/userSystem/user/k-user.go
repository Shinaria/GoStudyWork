...
func (p *UserID) FastRead(buf []byte) (int, error) {
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserID[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *UserID) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *UserID) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *UserID) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *UserID) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 1)
	offset += thrift.Binary.WriteI64(buf[offset:], p.No)
	return offset
}

func (p *UserID) field1Length() int {
	l := 0
...
func (p *UserInfo) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	...
	offset += p.Id.FastWriteNocopy(buf[offset:], w)
	return offset
}
...
func (p *UserServiceGetUserInfoArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 1)
	offset += p.Userid.FastWriteNocopy(buf[offset:], w)
	return offset
}
